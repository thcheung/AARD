...
parser.add_argument('--model', type=str, default="multi", metavar='N',
                    help='model name')
...
def train():
    ...
    for epoch in range(1, args.epochs+1):
        ...
        for i, batch in enumerate(tqdm(train_dataloader)):
            ...
            loss = 0.15 * criterion(outputs[0], labels) + 0.15 * criterion(outputs[1], labels) + 0.7 * criterion(outputs[2], labels)
            outputs = outputs[-1]
